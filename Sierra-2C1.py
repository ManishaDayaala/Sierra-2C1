...
MAINFOLDER = r"./APPdata_Sierra-2C1"

# Create other paths relative to the main folder
training_file_path = os.path.join(MAINFOLDER, "Training", "Training_Sierra-2C1.xlsx")  # FIXED TRAINING DATA
test_file_path = os.path.join(MAINFOLDER, "24hrData", "Dailydata_Sierra-2C1.xlsx")  # DAILY DATA
excel_file_path = os.path.join(MAINFOLDER, "Breakdownrecords_Sierra-2C1.xlsx")  # Recording excel for BD
folderpath = os.path.join(MAINFOLDER, "TemporaryData")  # Temporary dump files collector
threshold_file_path = os.path.join(MAINFOLDER,"Thresholds_Sierra-2C1.xlsx") #
...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        ...
        <span style="font-size: {title_font_size}px; font-weight: bold;">Breakdown Predictor-Sierra 2(C1)</span>
    </div>
...
def process_all_files():
    ...
    assets_list = [
        "Sierra-2 Burnising Spindle DE ","Sierra-2 Burnising Spindle NDE"]
